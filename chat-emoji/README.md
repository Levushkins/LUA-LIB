...
Разбор плагина чата Arizona Games (`_chat.asi`), извлечение всех **1573 смайлов и иконок**
...
| Скрытые: VIP и уровни | 26 |
| Скрытые: значки сервера | 14 |
| Скрытые: цифры и метки | 17 |
| Скрытые: оружие | 65 |
| Скрытые: недвижимость и чат | 32 |

Итого в атласе **1573** записи: 1354 из панели чата плюс 219 скрытых.
...
│   ├── emoji.json              1574 смайла: код, имена, категория
...
| `emoji.list` | массив всех 1573 записей: сперва панель чата, потом скрытые |
